 ...
 * claiming ownership
 * I found the Protected code on the following website
 * 
...
public class Protected {
    ...
    public static String decryptPass(String pw) throws Exception{
        ...
        String originalPassword = pw;
        String decryptedPassword = decrypt(originalPassword, key);
        return decryptedPassword;
    }
    
    public static String encryptPass(String pw) throws Exception{
        String password = "tester";
        if (password == null) {
            throw new IllegalArgumentException("Run with -Dpassword=<password>");
        }
